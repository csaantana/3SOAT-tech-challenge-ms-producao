...
public class KafkaConfig {
    ...
    public ProducerFactory<String, String> producerFactory() {
        ...
        configProps.put(ProducerConfig.BOOTSTRAP_SERVERS_CONFIG, "kafka-0.kafka.kafka.svc.cluster.local:9092");
    ...
    public ConsumerFactory<String, String> consumerFactory() {
        ...
        props.put(ConsumerConfig.BOOTSTRAP_SERVERS_CONFIG, "kafka-0.kafka.kafka.svc.cluster.local:9092");
